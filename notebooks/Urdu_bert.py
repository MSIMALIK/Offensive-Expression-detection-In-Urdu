# Generated from: Urdu_bert.ipynb
# Converted at: 2026-09-18T05:54:27.365Z
...
tokenizer = AutoTokenizer.from_pretrained('mwz/urdu-bert-small')
...
# ## Training
# 
# We use a pre-trained BERT model from HuggingFace. We use `RobertaModelWithHeads`, a class unique to `adapter-transformers`, which allows us to add and configure prediction heads in a flexibler way.


from transformers import AutoConfig , BertForSequenceClassification
configuration = AutoConfig.from_pretrained('mwz/urdu-bert-small', num_labels=2)
configuration.hidden_dropout_prob = hidden_dropout
model = BertForSequenceClassification.from_pretrained("mwz/urdu-bert-small", config=configuration)
...
train_df.to_excel("2-Train bert(1e-5)128SL-32BS-0.005HD-0.06WR-0.01WD.xlsx")

test_df.to_excel("2-Test bert(1e-5)128SL-32BS-0.005HD-0.06WR-0.01WD.xlsx")

# Save the Prediction labels to CSV files
predictions_df.to_csv('2-Predicion bert(1e-5)128SL-32BS-0.005HD-0.06WR-0.01WD.csv', index=False)